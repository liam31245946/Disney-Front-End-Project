...
const $dialogFavorite = document.querySelector('.favorite');
const $dialogDislike = document.querySelector('.dislike');
...
function handleAddToList(key, characterId) {
  ...
  const inList = list.some((character) => character._id === characterId);
...
const $favoritePage = document.querySelector('[data-view="favorite-page"]');
...
$viewFavoriteButton?.addEventListener('click', () => {
  ...
  const showRow = $favoritePage.querySelector('.row');
  showRow.innerHTML = '';
...
const $dislikePage = document.querySelector('[data-view="dislike-page"]');
...
$viewDislikeButton?.addEventListener('click', () => {
  ...
  const showRow = $dislikePage.querySelector('.row');
  showRow.innerHTML = '';
  // loop over all the chardata in favorite list
  displayFavorite.forEach((charData) => {
    const $character = renderCharacter(charData);
